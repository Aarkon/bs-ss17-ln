...
public class ThreadTest81 {
	 ...
	 * wechselseitigen Ausschluss mit abwechselnder Reihenfolge (inkl.
	 * wait/notify)
	 */
...
class OutputServer81 {
	...
	public synchronized void showOutput(Object output) {
		/*
		 * Output ausgeben. Waehrend der Ausgabe kann kein anderer Thread eine
		 * Ausgabe mit dieser Methode vornehmen, sondern kommt in die
		 * Monitor-Warteschlange des OutputServer81-Objekts.
		 */
		...
		try {
			...
			/*
			 * Partner aufwecken ("Staffelholz übergeben") --> Partner kommt in
			 * die Monitor-Queue ("ready"-Zustand)
			 */
			this.notify();
			/*
